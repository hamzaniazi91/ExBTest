...
class AlbumPane extends React.Component {
  ...
  getPhotos = filterValue => {
    ...
    let self = this;
    data = fetch(
      "http://jsonplaceholder.typicode.com/photos?albumId=" + filterValue
    )
      .then(response => {
  ...
  componentWillReceiveProps(newProps) {
    ...
    fetch(
      "http://jsonplaceholder.typicode.com/albums?userId=" + this.state.userId
    )
      .then(response => {
        return response.json();
      })
